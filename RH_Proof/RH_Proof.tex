...
\title{Recursive Rounding: A Constructive Proof of the \\ Riemann Hypothesis}
...
\begin{definition}  
\label{SPC}
 The \textbf{Sympletic Plane Correlation (SPC)} maps these 12 independent arithmetic residuals to the 12 canonical coordinates $(q_j, p_j)$ of the 6 conjugate planes in the transverse symplectic space. 
 \end{definition}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Sawtooth_Check.png}
...
The \textit{Sympletic Plane Correlation (SPC)} is the measure-preserving isomorphism $\mathcal{S}: \mathcal{K}_{12} \to \mathbb{T}^6 \times \mathbb{T}^6$ that maps the 12-dimensional configuration space onto 6 pairs of conjugate symplectic planes.

For any quantization residual $\psi(\varphi(x))$, the SPC ensures a pairwise phase-reversal such that:
\begin{equation}
...
\end{equation}
The weights $w_i$ are determined by the \textit{Sympletic Plane Correlation (SPC)} \ref{SPC}. The discrete deviation $\Delta(x, n)$ is realized as the evaluation of $f$ along the trajectory of the flow $\varphi$, such that $\Delta(x, n) = f(\varphi(x/n))$. 
...
\begin{lemma}[Construction of the SPC Weighting Vector] \label{lem:spc_weights}
Let $\mathcal{P}_{12} = \{p_1, p_2, \dots, p_{12}\}$ be the primorial base defining the transverse symplectic space $\mathbb{T}^{12}$. The Sympletic Plane Correlation (SPC) acts as a linear projection from the configuration space to the observable domain, determined by a static weighting vector $\mathbf{w} = (w_1, w_2, \dots, w_{12})$. 
\end{lemma}
...
\begin{proof}
By the construction of the \textit{Sympletic Plane Correlation}, the centered quantization residuals $(\theta_i - 1/2)$ are geometrically anti-symmetric about the center of the unit interval. Integration of these odd-symmetric modes against the translation-invariant Haar measure $\mu_H$ yields:
\begin{equation}
...
In this framework, the cage represents the deterministic boundary of the manifold where the sifting residuals are phase-locked by the \textit{Sympletic Plane Correlation}, preventing the "leakage" of spectral energy that would otherwise lead to a violation of the Riemann Hypothesis.
...
While classical stochastic models fail to account for the deterministic rigidity of the sifting envelope, our computational verification (see \ref{Comp Ver}) confirms that the cumulative error remains well within the Symplectic-Vaughan capacity limit across nine orders of magnitude.
...
\bibitem{apostol}
T. M. Apostol, \textit{Introduction to Analytic Number Theory}, Springer-Verlag, New York, 1976.

\bibitem{arnold1989}
V. I. Arnold, \textit{Mathematical Methods of Classical Mechanics}, Graduate Texts in Mathematics, Vol. 60, 2nd ed., Springer-Verlag, New York, 1989. Translated by K. Vogtmann and A. Weinstein.

\bibitem{berry1999hxp}
M. V. Berry and J. P. Keating, $H = xp$ and the Riemann Zeros, in: J. P. Keating, D. E. Khmelnitski, I. V. Lerner (Eds.), \textit{Supersymmetry and Trace Formulae: Chaos and Disorder}, NATO ASI Series, Vol. 370, Springer, pp. 355--367, 1999.

\bibitem{berry1999riemann}
M. V. Berry and J. P. Keating, The Riemann Zeros and Eigenvalue Asymptotics, \textit{SIAM Review} \textbf{41}(2) (236--266), 1999.

\bibitem{birkhoff1931proof}
G. D. Birkhoff, Proof of the ergodic theorem, \textit{Proceedings of the National Academy of Sciences} \textbf{17}(12) (656--660), 1931.

\bibitem{cramer1936order}
H. Cram{\'e}r, On the order of magnitude of the difference between consecutive prime numbers, \textit{Acta Arithmetica} \textbf{2}(1) (23--46), 1936.

\bibitem{Crandall2005}
R. Crandall and C. Pomerance, \textit{Prime Numbers: A Computational Perspective}, 2nd ed., Springer, New York, 2005.

\bibitem{folland1995abstract}
G. B. Folland, \textit{A Course in Abstract Harmonic Analysis}, Studies in Advanced Mathematics, CRC Press, Boca Raton, 1995.

\bibitem{froberg1968prime}
C.-E. Fr{\"o}berg, On the prime zeta function, \textit{{BIT} Numerical Mathematics} \textbf{8}(3) (187--202), 1968.

\bibitem{gabor1946theory}
D. Gabor, Theory of communication. Part 1: The analysis of information, \textit{Journal of the Institution of Electrical Engineers-Part III} \textbf{93}(26) (429--441), 1946.

\bibitem{gemini}
{Google}, Gemini, 2026. \url{https://gemini.google.com} (Accessed: 2026-03-20).

\bibitem{gromov}
M. Gromov, Pseudo holomorphic curves in symplectic manifolds, \textit{Inventiones mathematicae} \textbf{82} (307--347), 1885.

\bibitem{gutzwiller}
M. C. Gutzwiller, \textit{Chaos in Classical and Quantum Mechanics}, Springer-Verlag, New York, 1990.

\bibitem{halmos1950measure}
P. R. Halmos, \textit{Measure Theory}, Graduate Texts in Mathematics, Vol. 18, Springer-Verlag, New York, 1950.

\bibitem{hewitt1979abstract}
E. Hewitt and K. A. Ross, \textit{Abstract Harmonic Analysis: Volume I}, 2nd ed., Springer-Verlag, Berlin, 1979.

\bibitem{katok1995modern}
A. Katok and B. Hasselblatt, \textit{Introduction to the Modern Theory of Dynamical Systems}, Vol. 54, Cambridge University Press, Cambridge, 1995.

\bibitem{Kuipers2012}
L. Kuipers and H. Niederreiter, \textit{Uniform Distribution of Sequences}, Dover Publications, Mineola, NY, 2012. Reprint of the 1974 Wiley edition.

\bibitem{legendre}
A. M. Legendre, Essai sur la th\'eorie des nombres, \textit{Paris: Courcier}, 1808.

\bibitem{Lehmer1959}
D. H. Lehmer, On the exact number of primes less than a given limit, \textit{Illinois Journal of Mathematics} \textbf{3}(3) (381--388), 1959.

\bibitem{mathlib2020}
{The mathlib Community}, The Lean mathematical library, in: \textit{Proceedings of the 9th ACM SIGPLAN International Conference on Certified Programs and Proofs}, pp. 367--381, 2020.

\bibitem{mcduff2017introduction}
D. McDuff and D. Salamon, \textit{Introduction to Symplectic Topology}, 3rd ed., Oxford University Press, Oxford, UK, 2017.

\bibitem{moura2021lean4}
L. de Moura and S. Ullrich, The Lean 4 theorem prover and programming language, in: \textit{International Conference on Automated Deduction}, Springer, pp. 625--635, 2021.

\bibitem{odlyzko}
A. M. Odlyzko and H. J. J. te Riele, Disproof of the Mertens Conjecture, \textit{Journal f{\"u}r die reine und angewandte Mathematik} \textbf{1985}(357) (138--160), 1985.

\bibitem{pilyugin1999shadowing}
S. Yu. Pilyugin, \textit{Shadowing in Dynamical Systems}, Lecture Notes in Mathematics, Vol. 1706, Springer-Verlag, Berlin, Heidelberg, 1999.

\bibitem{riemann}
B. Riemann, Ueber die Anzahl der Primzahlen unter einer gegebenen Gr{\"o}sse, \textit{Monatsber. Akad. Berlin}, 1859. Available at: \url{https://www.claymath.org/wp-content/uploads/2023/04/Wilkins-transcription.pdf}.
...
W. Rudin, \textit{Real and Complex Analysis}, 3rd ed., McGraw-Hill Education, New York, 1987.

\bibitem{sarnak}
P. Sarnak, Three Lectures on the M{\"o}bius Function, Randomness and Dynamics, \textit{IAS Lecture Notes}, 2010. Available at: \url{https://publications.ias.edu/sarnak/paper/506}.

\bibitem{shannon1949communication}
C. E. Shannon, Communication in the presence of noise, \textit{Proceedings of the IRE} \textbf{37}(1) (10--21), 1949.

\bibitem{stein2003fourier}
E. M. Stein and R. Shakarchi, \textit{Fourier Analysis: An Introduction}, Vol. 1, Princeton University Press, Princeton, NJ, 2003.

\bibitem{vaughan}
R. C. Vaughan, \textit{The Hardy-Littlewood Method}, Cambridge University Press, Cambridge, 1997.

\bibitem{vonkoch}
H. Von Koch, Sur la distribution des nombres premiers, \textit{Acta Math.} \textbf{24} (159--182), 1901.

\bibitem{weil}
A. Weil, On some exponential sums, \textit{Proc. Nat. Acad. Sci.} \textbf{34}(5) (204--207), 1948.

\bibitem{weyl}
H. Weyl, {\"U}ber die Gleichverteilung von Zahlen mod. Eins, \textit{Math. Ann.} \textbf{77} (313--352), 1916.
\end{thebibliography}

\section*{Supplement}
\subsection*{Computational Verification Log}
\label{Comp Ver}
...
\subsection*{The ``Exact'' Sieve Algorithm}
